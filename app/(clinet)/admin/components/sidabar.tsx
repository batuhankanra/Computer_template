  ...
  return (
     <aside className="w-64 bg-third border-r shadow-sm hidden md:block">
      ...
      <nav className="p-4 space-y-2 ">
        ...
        <Link href="/admin/user" className=" block font-semibold border border-third hover:border-secondary py-2 rounded-lg px-1 transition-all duration-200">Kullanıcılar</Link>
